...
> R:falla, espera 700 y obtuvo 350
...
> R: linea 24, al total se le suma el precio 

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R: al total se le suma el precio  multiplicado por la cantidad
...
> R:29 y 30, los test unitarios no llaman a la funcion
...
> R: el unitario valida las funciones de manera individual y el de integracion que funcionen juntas, lo detecto pirmero el unitario
...
> R: en C no verifica que el acceso este dentro del limite y Python y java si tienen comporbacion
...
> R: puedo probar con un caso especifico y me indica exactamente el error y donde 
...
> R:porque el primero se tenia que multiplicar por 1, por lo que no afecto, pero el segundo era por 2 asi que si afecta
